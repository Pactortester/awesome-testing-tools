...
- [TabQA](https://tabqa.openutx.cn/en/) - Browser-based Android testing workbench to mirror, control, inspect network traffic, capture logs, and record bug reproduction video buffers in Chrome via WebUSB without ADB setup.
